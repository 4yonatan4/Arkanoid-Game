 ...
 */
public class FillRectangle implements Sprite {
    ...
    /**
     * Instantiates a new FillRectangle.
     *
     * @param upperLeft the upper left point
     * @param width     the width
     * @param height    the height
     */
    public FillRectangle(Point upperLeft, double width, double height) {
    ...
    /**
     * Instantiates a new Fill rectangle.
     *
     * @param x      the x
     * @param y      the y
     * @param width  the width
     ...
     */
    public FillRectangle(double x, double y, double width, double height, Color color) {
        this.point = new Point(x, y);
        this.width = width;
        this.height = height;
        this.recColor = color;
    ...
    public void drawOn(DrawSurface d) {
        ...
        d.fillRectangle((int) point.getX(), (int) point.getY(), (int) getWidth(), (int) getHeight());
    }
